...
flags.DEFINE_integer('preprocess_batch_size', 2, 'Batch size for the model.')
flags.DEFINE_integer(
    'preprocess_shuffle_batch_num_threads', 2,
    'Number of threads doing the second half of preprocessing during training.')
flags.DEFINE_integer('preprocess_batch_capacity', 8,
